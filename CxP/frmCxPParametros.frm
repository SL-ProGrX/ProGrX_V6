...
Begin VB.Form frmCxPParametros 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ...
   Begin FPSpreadADO.fpSpread vGrid 
      ...
      MaxCols         =   496
      ScrollBars      =   2
      SpreadDesigner  =   "frmCxPParametros.frx":0000
      VScrollSpecialType=   2
      AppearanceStyle =   1
   End
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Parámetros de Cuentas por Pagar"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   13.8
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmCxPParametros"
...
strSQL = "exec spCxPParametros"
Call ConectionExecute(strSQL)


strSQL = "select * from cxp_parametros" _
...
strSQL = "update cxp_parametros set modifica_usuario = '" & glogon.Usuario & "', modifica_Fecha = dbo.MyGetdate()" _
       & ",valor = '" & Trim(pValor) & "' where cod_parametro = '" & pParametro & "'"
Call ConectionExecute(strSQL)

strSQL = "Parámetro de CxP: " & pParametro & " -> " & pValor
