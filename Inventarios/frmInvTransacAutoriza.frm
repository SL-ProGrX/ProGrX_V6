...
Begin VB.Form frmInvTransacAutoriza 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Resoluciona una Transaccion de Movimiento de Inventarios"
   ClientHeight    =   2820
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   9570
   ...
   Begin XtremeSuiteControls.PushButton btnResolucion 
      ...
      Appearance      =   17
      Picture         =   "frmInvTransacAutoriza.frx":0000
   End
   ...
   Begin XtremeSuiteControls.PushButton btnResolucion 
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmInvTransacAutoriza.frx":0772
   End
   Begin VB.Label lblEstado 
      BackStyle       =   0  'Transparent
      Caption         =   "Resolución para Procesamientos de solicitudes de cambios en el inventario"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   9
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmInvTransacAutoriza"
