...
Begin VB.Form frmInvTranTraslados 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Inventario: Traslados entre Bodegas"
   ClientHeight    =   7080
   ClientLeft      =   48
   ClientTop       =   432
   ClientWidth     =   12420
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInvTranTraslados.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInvTranTraslados.frx":08DA
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInvTranTraslados.frx":0BF4
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInvTranTraslados.frx":0F0E
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInvTranTraslados.frx":1228
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin FPSpreadADO.fpSpread vGrid 
      ...
      MaxCols         =   488
      ScrollBars      =   2
      SpreadDesigner  =   "frmInvTranTraslados.frx":1B02
   ...
   End
End
Attribute VB_Name = "frmInvTranTraslados"
...
If Not rs.BOF And Not rs.EOF Then
  ...
  strSQL = "select D.cod_producto,P.descripcion,D.cantidad,B.cod_bodega,B.descripcion as Bodega,D.precio,(D.cantidad * D.precio) as Total" _
         & ",isnull(D.despacho,0) as Despacho,X.descripcion as BodDestino,D.cod_bodega_destino" _
         ...
         & " inner join PV_Bodegas X on D.cod_bodega_destino = X.cod_bodega" _
...
Do While Not rs.EOF
  ...
  For i = 1 To vGrid.MaxCols
        Select Case i
          ...
          Case 4 'Bodega Origen
              vGrid.col = i
              vGrid.Text = CStr(rs!cod_bodega)
              vGrid.TextTip = TextTipFixed
              vGrid.CellNote = rs!Bodega
          
          Case 5 'Bodega Destino
              vGrid.col = i
              vGrid.Text = CStr(rs!cod_Bodega_Destino)
              vGrid.TextTip = TextTipFixed
              vGrid.CellNote = rs!BodDestino
...
vMensaje = fxInvVerificaLineaDetalle(vGrid, 3, "T", 1, 4, 5)
...
If vEdita Then
    ...
    Call Bitacora("Modifica", "TranSac Inventario Tipo:" & vTipo & ", Cod: " & vCodigo)
...
Else
    ...
    Call Bitacora("Registra", "TranSac Inventario Tipo:" & vTipo & ", Cod: " & vCodigo)
...
For i = 1 To vGrid.MaxRows
  ...
  If vGrid.Text <> "" And curCantidad > 0 Then
    ...
    vGrid.col = 1
    strSQL = strSQL & Space(10) & "insert pv_InvTraDet(linea,Boleta,tipo,cod_producto,cod_bodega,cod_bodega_destino,cantidad,despacho,precio)" _
...
Select Case UCase(ButtonMenu.Key)
  Case "REPBOLETA"
     InvTransacRep.Reporte = "TrasladoC"
     frmInvTransacReporteOrden.Show vbModal
  
  Case "REPBOLETAVENTA"
     InvTransacRep.Reporte = "TrasladoV"
     frmInvTransacReporteOrden.Show vbModal
...
If (vGrid.ActiveCol = 4 Or vGrid.ActiveCol = 5) And KeyCode = vbKeyReturn Then
   vGrid.col = vGrid.ActiveCol
