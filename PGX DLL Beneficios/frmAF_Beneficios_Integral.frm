...
Begin VB.Form frmAF_Beneficios_Integral 
   ...
   Begin XtremeSuiteControls.TabControl tcMain 
      ...
      Begin XtremeSuiteControls.TabControl tcCRECE 
         ...
         Color           =   32
         ItemCount       =   3
         Item(0).Caption =   "Educación Financiera"
         ...
         Begin XtremeSuiteControls.Label Label1 
            ...
            _ExtentY        =   450
            _StockProps     =   79
            Caption         =   "Aplicación del Producto Financiero"
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Calibri"
               Size            =   9
               Charset         =   0
...
Select Case True
    ...
    Case rs!I_RECONOCIMIENTOS = 1 '"B_RECO" 'Reconocimientos Mayra Soto Hernández
