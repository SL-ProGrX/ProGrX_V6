...
Begin VB.Form frmCR_PolizasRemesaPago 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pólizas: Remesas de Pagos"
   ClientHeight    =   7560
   ClientLeft      =   48
   ClientTop       =   372
   ClientWidth     =   10524
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Picture         =   "frmCR_PolizaRemesaPago.frx":0000
   ScaleHeight     =   7560
   ScaleWidth      =   10524
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":6852
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":1D214
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":33BD6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":48D48
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":5DEBA
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgToolbarIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   9
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":7487C
            Key             =   "New"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":7498E
            Key             =   "Properties"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":74AA0
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":74BB2
            Key             =   "Save"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":74CC4
            Key             =   "Undo"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":74DD6
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":74EE8
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":74FFA
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCR_PolizaRemesaPago.frx":7510C
            Key             =   "Open"
         EndProperty
      EndProperty
   End
   Begin TabDlg.SSTab ssTab 
      ...
      EndProperty
      TabCaption(0)   =   "Remesa"
      TabPicture(0)   =   "frmCR_PolizaRemesaPago.frx":7521E
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Line1(12)"
      ...
      Tab(0).Control(6)=   "Line1(1)"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "Line1(15)"
      ...
      Tab(0).Control(17)=   "Label2(8)"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "Label2(20)"
   ...
   Begin VB.Label Label6 
      Caption         =   "Remesas para Pagos a la Aseguradora"
      BeginProperty Font 
         Name            =   "Arial Narrow"
         Size            =   15.6
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmCR_PolizasRemesaPago"
...
strSQL = "select isnull(max(Fecha_Corte),dbo.MyGetdate()) as 'Corte', dbo.MyGetdate() as 'Inicio' from INS_REMESAS where Tipo = '" & Mid(cboTipo.Text, 1, 1) & "'"
Call OpenRecordSet(rs, strSQL)
...
If optTipo.Item(0).Value Then
   ...
   .Formulas(3) = "fxTitulo='REMESA TRASLADO A TESORERIA : PAGO COMISIONES'"
    Select Case True
     Case opt.Item(0).Value 'Pendiente Detalle Remesa
        .ReportFileName = SIFGlobal.fxPathReportes("Ins_RemesaVenDetalle.rpt")
        vSubTitulo = "REMESA : " & lblRemesa.Tag & " LISTADO : DETALLADO"
     Case opt.Item(1).Value 'Traslado Detalle Agrupado Remesa
        .ReportFileName = SIFGlobal.fxPathReportes("Ins_RemesaVenDetalleAgrp.rpt")
 ...
 Else
   ...
   .Formulas(3) = "fxTitulo='REMESA TRASLADO A TESORERIA : PAGO ASEGURADORA'"
    ...
    Select Case True
     Case opt.Item(0).Value 'Pendiente Detalle Remesa
        .ReportFileName = SIFGlobal.fxPathReportes("Ins_RemesaAseDetalle.rpt")
        vSubTitulo = "REMESA : " & lblRemesa.Tag & " LISTADO : DETALLADO"
     Case opt.Item(1).Value 'Traslado Detalle Agrupado Remesa
        .ReportFileName = SIFGlobal.fxPathReportes("Ins_RemesaAseDetalleAgrp.rpt")
        vSubTitulo = "REMESA : " & lblRemesa.Tag & " LISTADO : DETALLADO AGRUPADO"
    End Select
...
Select Case UCase(Button.Key)
  Case "NUEVO"
    ...
    If txtRemesa.Text = "" Then
            ...
            strSQL = "select isnull(max(cod_remesa),0) + 1 as Ultimo from INS_REMESAS"
            Call OpenRecordSet(rs, strSQL)
...
strSQL = "select Pag.Num_Poliza,Pag.Num_Cuota,Pag.Monto,Pol.Cedula,Pol.Tipo_Seguro,Ven.Nombre as 'Vendedor'" _
       & ", Pag.Monto_Pago,Pag.Comision_Interna,Pag.Comision_Vendedor" _
       & " from ins_Polizas Pol inner join ins_Pagos Pag on Pol.num_poliza = Pag.num_poliza" _
    ...
    With lswCarga
     ...
     Do While Not rs.EOF
       Set itmX = .ListItems.Add(, , rs!Num_Poliza)
           ...
           itmX.SubItems(3) = Format(rs!Comision_Vendedor, "Standard")
           itmX.SubItems(4) = rs!Cedula
           itmX.SubItems(5) = rs!Tipo_Seguro
           itmX.SubItems(6) = rs!Vendedor
    ...
    With lswCarga
     ...
     Do While Not rs.EOF
       Set itmX = .ListItems.Add(, , rs!Num_Poliza)
           itmX.SubItems(1) = rs!num_cuota
           itmX.SubItems(2) = Format(rs!Monto, "Standard")
           itmX.SubItems(3) = Format(rs!Comision_Interna, "Standard")
 ...
 If .Item(i).Checked Then
     ...
     If cboVendedor.Enabled Then
        strSQL = "update INS_PAGOS Set cod_remesa_comision = " & cboCarga.ItemData(cboCarga.ListIndex) _
               & " where NUM_POLIZA = '" & .Item(i).Text & "' AND NUM_CUOTA = " & .Item(i).SubItems(1)
     Else
