...
Call Bitacora("Aplica", "Actualización de Pólizas: Masiva")

btnActualizaPolizas.Caption = "Actualización de Pólizas"
...
i = MsgBox("Esta seguro que desea realizar la actualización de Pólizas de todas las Operaciones?", vbYesNo)
If i = vbYes Then
