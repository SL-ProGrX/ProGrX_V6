...
Dim rs As New ADODB.Recordset
  ...
  lblVersion.Caption = "Version " & App.Major & "." & App.Minor & "." _
                     & App.Revision
  lblTitle.Caption = App.ProductName & vbCrLf & "Edición SQL Server"
  lblCopyright.Caption = App.LegalCopyright
  lblDescription.Caption = App.Comments
    
 lblUso.Caption = "Uso Autorizado a : " & vbCrLf & vbCrLf _
        & "         " & vParametros.EmpresaLocal
End Sub
