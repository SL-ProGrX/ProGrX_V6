...
Begin VB.Form frmPres_Roles_Acceso 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Roles de Acceso"
   ClientHeight    =   10650
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   11130
   ...
   Begin XtremeSuiteControls.TabControl tcMain 
      ...
      Begin FPSpreadADO.fpSpread vGrid 
         ...
         MaxCols         =   5
         ScrollBars      =   2
         SpreadDesigner  =   "frmPres_Roles_Acceso.frx":0000
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Roles de Acceso para Visualización de Presupuesto"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   13.5
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmPres_Roles_Acceso"
...
For i = 1 To .Count
    If .Item(i).Checked Then
        strSQL = strSQL & Space(10) & "exec spPres_AC_Cuentas_Asigna " & gCntX_Parametros.CodigoConta & ", '" & scRol.Tag _
...
strSQL = "exec spPres_AC_Rol_List " & gCntX_Parametros.CodigoConta & ", '" & glogon.Usuario & "'"
...
If vGrid.Text <> "" Then
    strSQL = "exec spPres_AC_Rol_Add " & gCntX_Parametros.CodigoConta & ", '" & Trim(vGrid.Text) & "', '"
    vGrid.Col = 2
...
strSQL = "exec spPres_AC_Cuentas_Consulta " & gCntX_Parametros.CodigoConta & ", '" & scRol.Tag & "', '" & txtCtaInicial.Text _
...
strSQL = "exec spPres_AC_Cuentas_Consulta_Asignadas " & gCntX_Parametros.CodigoConta & ", '" & scRol.Tag & "', '" & txtFiltros.Text & "', '" & glogon.Usuario & "'"
...
strSQL = "exec spPres_AC_Centro_Costo_Asigna " & gCntX_Parametros.CodigoConta & ", '" & scRol.Tag & "', '" & scUnidad.Tag _
...
strSQL = "exec spPres_AC_Cuentas_Asigna " & gCntX_Parametros.CodigoConta & ", '" & scRol.Tag _
       & "', '" & Item.Text & "', '" & glogon.Usuario _
       & "', '" & IIf(Item.Checked, "A", "E") & "'"
Call ConectionExecute(strSQL)
...
strSQL = "exec spPres_AC_Unidades_Consulta " & gCntX_Parametros.CodigoConta & ", '" & scRol.Tag & "', '" & txtFiltros.Text & "', '" & glogon.Usuario & "'"
...
strSQL = "exec spPres_AC_Miembros_Asigna " & gCntX_Parametros.CodigoConta & ", '" & scRol.Tag _
       & "', '" & Item.Text & "', '" & glogon.Usuario _
       & "', '" & IIf(Item.Checked, "A", "E") & "'"
Call ConectionExecute(strSQL)
...
strSQL = "exec spPres_AC_Unidades_Asigna " & gCntX_Parametros.CodigoConta & ", '" & scRol.Tag _
       & "', '" & Item.Text & "', '" & glogon.Usuario _
       & "', '" & IIf(Item.Checked, "A", "E") & "'"
Call ConectionExecute(strSQL)
...
strSQL = "exec spPres_AC_Centro_Costo_Consulta " & gCntX_Parametros.CodigoConta & ", '" & scRol.Tag & "', '" & scUnidad.Tag _
...
strSQL = "exec spPres_AC_Miembros_Consulta " & gCntX_Parametros.CodigoConta & ", '" & scRol.Tag & "', '" & txtFiltros.Text & "', '" & glogon.Usuario & "'"
...
If KeyCode = vbKeyDelete Then
     ...
     If i = vbYes Then
        ...
        vGrid.Row = vGrid.ActiveRow
        vGrid.Col = 1
        strSQL = "exec spPres_AC_Rol_Delete " & gCntX_Parametros.CodigoConta & ", '" & vGrid.Text _
               & "', '" & glogon.Usuario & "'"
        Call ConectionExecute(strSQL)
