...
Begin VB.Form frmSYS_IVA_Parametros 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "IVA: Parámetros Generales"
   ClientHeight    =   6960
   ClientLeft      =   36
   ClientTop       =   384
   ClientWidth     =   9948
   ...
   Begin FPSpreadADO.fpSpread vGrid 
      ...
      MaxCols         =   496
      ScrollBars      =   2
      SpreadDesigner  =   "frmSYS_IVA_Parametros.frx":0000
      VScrollSpecialType=   2
      AppearanceStyle =   1
   End
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Parámetros para Administración del IVA"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   13.8
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmSYS_IVA_Parametros"
...
strSQL = "exec spSys_IVA_Parametros"
Call ConectionExecute(strSQL)


strSQL = "select * from SYS_IVA_PARAMETROS" _
...
strSQL = "update SYS_IVA_PARAMETROS set modifica_usuario = '" & glogon.Usuario & "', modifica_Fecha = dbo.MyGetdate()" _
       & ",valor = '" & Trim(pValor) & "' where cod_parametro = '" & pParametro & "'"
Call ConectionExecute(strSQL)

strSQL = "Parámetro de IVA: " & pParametro & " -> " & pValor
