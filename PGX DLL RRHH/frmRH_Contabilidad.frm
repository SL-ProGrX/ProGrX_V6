...
Begin VB.Form frmRH_Contabilidad 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "RRHH: Traslado de Asientos"
   ClientHeight    =   6840
   ClientLeft      =   30
   ClientTop       =   390
   ClientWidth     =   10635
   ...
   Begin XtremeSuiteControls.PushButton cmdBuscar 
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmRH_Contabilidad.frx":0000
   End
   Begin XtremeSuiteControls.PushButton cmdTrasladar 
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmRH_Contabilidad.frx":0A1E
   End
   ...
   End
End
Attribute VB_Name = "frmRH_Contabilidad"
  ...
  If .Item(i).Checked Then
    ...
    If fxgCntPeriodoValida(CDate(.Item(i).SubItems(2))) Then
        ...
        strSQL = "insert into CntX_Asientos(COD_CONTABILIDAD,tipo_asiento,num_asiento,anio,mes,fecha_asiento" _
               & ",descripcion,balanceado,notas,modulo,user_crea) (select COD_CONTABILIDAD,tipo_asiento" _
               & ",num_asiento,anio,mes,fecha_asiento,descripcion,'S',Notas," & vModulo & ",user_crea" _
