...
Begin VB.Form frmUS_Bitacora 
   ...
   Begin XtremeSuiteControls.PushButton btnConsulta 
      ...
      TextAlignment   =   1
      Appearance      =   17
      Picture         =   "frmUS_Bitacora.frx":000C
      ImageAlignment  =   4
   End
   ...
   Begin XtremeSuiteControls.PushButton btnExporta 
      ...
      TextAlignment   =   1
      Appearance      =   17
      Picture         =   "frmUS_Bitacora.frx":070C
      ImageAlignment  =   4
   End
   ...
   Begin FPSpreadADO.fpSpread vGrid 
      ...
      EndProperty
      MaxCols         =   11
      SpreadDesigner  =   "frmUS_Bitacora.frx":0FDD
   ...
   End
End
Attribute VB_Name = "frmUS_Bitacora"
...
If gPortal.Empresa_Id = -1 Then
    MsgBox "Debe de Seleccionar una Empresa antes de ingresar a consulta de bitácora", vbExclamation
