...
Begin VB.Form frmCR_CancelaMorosidad 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cancela Cuotas Morosas"
   ClientHeight    =   5865
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9450
   HelpContextID   =   3004
   Icon            =   "frmCR_CancelaMorosidad.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   Picture         =   "frmCR_CancelaMorosidad.frx":030A
   ScaleHeight     =   5865
   ScaleWidth      =   9450
   ...
   Begin VB.ComboBox cboTipoAbono 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmCR_CancelaMorosidad.frx":6B5C
      Left            =   1200
      List            =   "frmCR_CancelaMorosidad.frx":6B66
   ...
   Begin VB.ComboBox cboTipo 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmCR_CancelaMorosidad.frx":6B7C
      Left            =   1200
      List            =   "frmCR_CancelaMorosidad.frx":6B7E
      Style           =   2  'Dropdown List
      TabIndex        =   16
      Top             =   5040
      Width           =   2055
   ...
   Begin VB.ComboBox cboTipoPago 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmCR_CancelaMorosidad.frx":6B80
      Left            =   1200
      List            =   "frmCR_CancelaMorosidad.frx":6B90
      Style           =   2  'Dropdown List
      TabIndex        =   13
      Top             =   5400
      Width           =   2055
   ...
   Begin VB.CommandButton cmdGenerarRecibo 
      ...
      Height          =   855
      Left            =   7800
      Picture         =   "frmCR_CancelaMorosidad.frx":6BB7
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   Begin VB.Image imgBusqueda_Rapida 
      ...
      Index           =   1
      Left            =   5400
      Picture         =   "frmCR_CancelaMorosidad.frx":6CEF
   ...
   Begin VB.Image imgBusqueda_Rapida 
      ...
      Index           =   0
      Left            =   9000
      Picture         =   "frmCR_CancelaMorosidad.frx":6DE8
      Stretch         =   -1  'True
      ToolTipText     =   "Busqueda Rápida"
      Top             =   840
      Width           =   255
   ...
   Begin VB.Image imgBusqueda_Rapida 
      ...
      Index           =   2
      Left            =   9000
      Picture         =   "frmCR_CancelaMorosidad.frx":6EE1
      Stretch         =   -1  'True
      ToolTipText     =   "Busqueda Rápida"
      Top             =   1200
      Width           =   255
   End
End
Attribute VB_Name = "frmCR_CancelaMorosidad"
...
With frmContenedor.Crt
 ...
 .ReportFileName = SIFGlobal.fxPathReportes("crCM.rpt")
 ...
 If rs!IntC + rs!IntM + rs!Amortiza + rs!Cargo > curRepartido(1) _
  ...
  'Insertar Registro con la diferencia
   strSQL = "insert morosidad(id_solicitud,codigo,fechap,intc,intm,amortiza," _
         ...
         & ",'A'," & GLOBALES.glngFechaCR & ",'A',dbo.MyGetdate()," _
...
strSQL = "select cod_divisa from reg_creditos where id_solicitud = " & txtId_solicitud.Text
Call OpenRecordSet(rs, strSQL)
If rs!cod_Divisa = "DOL" Then
   MsgBox "- Esta Operación es dólares! Debe usar el módulo de Cajas para realizar movimientos", vbExclamation
   rs.Close
   Exit Sub
End If
rs.Close
...
glogon.Conection.BeginTrans
    ...
    strSQL = "update morosidad set tcon = '" & fxTipoASENumero(fxTipoASEDoc(cboTipo.Text)) _
...
Call EstableceUltimoAbono
  ...
  If vUltimoRecibo > 0 And vPaso Then _
    Call sbImprimeRecibo(vUltimoRecibo, fxTipoASEDoc(cboTipo.Text))
