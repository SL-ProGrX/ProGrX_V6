...
Begin VB.Form frmCR_Comisiones_Bancos 
   ...
   Caption         =   "Cuentas Bancarias para Pago de Comisiones de Crédito"
   ClientHeight    =   6564
   ClientLeft      =   36
   ClientTop       =   384
   ClientWidth     =   8220
   ...
   Begin XtremeShortcutBar.ShortcutCaption scTitulo 
      ...
      _ExtentY        =   1503
      _StockProps     =   14
      Caption         =   "Seleccione las Cuentas Bancarias y sus tipos de desembolsos para Comisiones de Colocación de Créditos"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Calibri"
         Size            =   9
         Charset         =   0
