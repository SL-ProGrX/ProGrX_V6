...
Begin VB.Form frmSYS_APL_Monitor 
   Caption         =   "APL: Monitor v2"
   ClientHeight    =   9576
   ClientLeft      =   48
   ClientTop       =   396
   ClientWidth     =   12804
   ...
   Begin XtremeSuiteControls.GroupBox Box_Tramite 
      ...
      Begin XtremeSuiteControls.PushButton btnRefrescar_Tramite 
         ...
         FlatStyle       =   -1  'True
         Appearance      =   16
         Picture         =   "frmSYS_APL_Monitor.frx":0000
      End
      Begin FPSpreadADO.fpSpread vGrid_Tramite 
         ...
         EndProperty
         MaxCols         =   504
         SpreadDesigner  =   "frmSYS_APL_Monitor.frx":098D
   ...
   Begin XtremeSuiteControls.GroupBox Box_PreSolicitud 
      ...
      Begin XtremeSuiteControls.PushButton btnRefresh_Solicitud 
         ...
         FlatStyle       =   -1  'True
         Appearance      =   16
         Picture         =   "frmSYS_APL_Monitor.frx":1483
      End
      Begin FPSpreadADO.fpSpread vGrid_Solicitud 
         ...
         EndProperty
         MaxCols         =   499
         SpreadDesigner  =   "frmSYS_APL_Monitor.frx":1E10
         VScrollSpecial  =   -1  'True
         VScrollSpecialType=   2
         AppearanceStyle =   1
      End
   ...
   End
End
Attribute VB_Name = "frmSYS_APL_Monitor"
