...
'  Case opt.Item(0).Value 'Pendiente Detalle Remesa
     .ReportFileName = SIFGlobal.fxSIFPathReportes("FSL_RemesaTesDetalle.rpt")
     vSubTitulo = "REMESA : " & lblRemesa.Tag & " LISTADO : DETALLADO"
'  Case opt.Item(1).Value 'Traslado Detalle Agrupado Remesa
'     .ReportFileName = SIFGlobal.fxSIFPathReportes("CxC_RemesaTESDetalleAgrp.rpt")
...
With frmContenedor.Crt
 ...
 .ReportFileName = SIFGlobal.fxSIFPathReportes("CBR_CJ_ListadoRemesa.rpt")
 .PrintReport
...
strRuta = SIFGlobal.fxSIFPathReportes("CBR_CJ_GastoPenEnviar.rpt")
...
With frmContenedor.Crt
    ...
    If cboRepOficina.Text <> "TODOS" Then
       strSQL = strSQL & " AND {REG_CREDITOS.COD_OFICINA_F} = '" & SIFGlobal.fxSIFCodText(cboRepOficina.Text) & "'"
       
       strFiltro = strFiltro & " /OFICINA " & SIFGlobal.fxSIFCodText(cboRepOficina.Text)
    Else
...
With frmContenedor.Crt
 ...
 .ReportFileName = SIFGlobal.fxSIFPathReportes("CBR_CJ_GastoTrasladadas.rpt")
 .Formulas(1) = "Empresa='" & GLOBALES.gstrNombreEmpresa & "'"
 .Formulas(2) = "Fecha='" & Format(fxFechaServidor, "dd/mm/yyyy") & "'"
