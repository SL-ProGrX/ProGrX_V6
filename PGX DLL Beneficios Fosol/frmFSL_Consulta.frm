...
Begin VB.Form frmFSL_Consulta 
   ...
   Begin VB.Frame fraFiltros 
      ...
      Begin VB.ComboBox cboEstadoPersona 
         ...
         Width           =   2655
      End
      Begin VB.TextBox txtUsuarioRegistra 
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.ComboBox cboPlan 
      ...
      Width           =   1935
   End
   Begin VB.CheckBox chkEnfermedades 
   ...
   Begin MSComctlLib.StatusBar StatusBarX 
      ...
      EndProperty
   End
   Begin MSComctlLib.ListView lswCausas 
      Height          =   3375
      Left            =   120
      TabIndex        =   35
      Top             =   480
   ...
   Begin MSComCtl2.DTPicker dtpCorte 
      ...
      CurrentDate     =   37678
   End
   Begin MSComctlLib.ListView lswEnfermedades 
      Height          =   1815
      Left            =   120
      TabIndex        =   38
      Top             =   4320
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFSL_Consulta.frx":1597
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFSL_Consulta.frx":7DF9
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFSL_Consulta.frx":E65B
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFSL_Consulta.frx":14EBD
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFSL_Consulta.frx":14FF4
            Key             =   ""
         EndProperty
      EndProperty
   End
...
If cboComite.Text <> "TODOS" Then
    ...
    strSQL = "select rtrim(cedula) + ' - ' + rtrim(Nombre) as ItmX from FSL_COMITES_MIEMBROS" _
           & " where cod_comite = '" & SIFGlobal.fxSIFCodText(cboComite.Text) & "' and Activo = 1 order by Nombre"
...
If cboPlan.Text <> "TODOS" Then
   ...
   lswCausas.ListItems.Clear
    strSQL = "select cod_causa as IdX, rtrim(descripcion) as ItmX from FSL_PLANES_CAUSAS" _
           & " where cod_plan = '" & SIFGlobal.fxSIFCodText(cboPlan.Text) & "' and Activa = 1 order by Descripcion"
...
If cboPlan.Text <> "TODOS" Then
    strSQL = strSQL & " and cod_Plan = '" & SIFGlobal.fxSIFCodText(cboPlan.Text) & "'"
...
'Filtros Adicionales
  ...
  If cboEstadoPersona.Text <> "TODOS" Then
      strSQL = strSQL & " and EstadoActual = '" & SIFGlobal.fxSIFCodText(cboEstadoPersona.Text) & "'"
  End If
  
  If cboComite.Text <> "TODOS" Then
      strSQL = strSQL & " and COD_COMITE = '" & SIFGlobal.fxSIFCodText(cboComite.Text) & "'"
      
      
      If cboMiembros.Text <> "TODOS" Then
          strSQL = strSQL & " and dbo.fxFSL_Expediente_ComiteMiembro(Cod_Expediente,'" & SIFGlobal.fxSIFCodText(cboMiembros.Text) & "') >= 1"
      End If
  ...
  If cboGestiones.Text <> "TODOS" Then
      strSQL = strSQL & " and dbo.fxFSL_Expediente_GestionRegistrada(cod_Expediente,'" & SIFGlobal.fxSIFCodText(cboGestiones.Text) & "') >= 1"
  End If

  If cboApelacion.Text <> "TODOS" Then
      strSQL = strSQL & " and dbo.fxFSL_Expediente_ApelacionRegistrada(cod_Expediente,'" & SIFGlobal.fxSIFCodText(cboApelacion.Text) & "') >= 1"
  End If
...
strSQL = "select COD_PLAN + ' - ' + rtrim(Descripcion) as itmx from FSL_PLANES  where activo = 1 order by descripcion"
Call sbLlenaCbo(cboPlan, strSQL, True)
...
'                   .ReportFileName = SIFGlobal.fxSIFPathReportes("Cbr_CJTramiteDetalle.rpt")
''                Else
''                   .ReportFileName = SIFGlobal.fxSIFPathReportes("SIFDocGeneralRsm.rpt")
''                End If
'            Case optReportes.Item(1).Value 'Agrupado por Usuario
'                If Mid(cboTipoReporte, 1, 1) = "D" Then
'                    .ReportFileName = SIFGlobal.fxSIFPathReportes("Cbr_CJTramiteDetallexUsuario.rpt")
'                Else
'                    .ReportFileName = SIFGlobal.fxSIFPathReportes("Cbr_CJTramiteResumenxUsuario.rpt")
'                End If
'
'            Case optReportes.Item(3).Value 'Agrupado por Oficina
'                If Mid(cboTipoReporte, 1, 1) = "D" Then
'                    .ReportFileName = SIFGlobal.fxSIFPathReportes("Cbr_CJTramiteDetallexOficina.rpt")
'                Else
'                    .ReportFileName = SIFGlobal.fxSIFPathReportes("Cbr_CJTramiteResumenxOficina.rpt")
'                End If
'
'        End Select
''
...
Select Case Col
  Case 1 'Expediente
    Call sbSIFForms("frmFSL_Expediente")
  ...
  Case 2 'Gestiones
    ...
    Call sbSIFForms("frmFSL_ExpedienteGestiones")
    
  Case 3 'Apelaciones
    GLOBALES.gTag = pExpediente
    Call sbSIFForms("frmFSL_ExpedienteApelaciones")
End Select
