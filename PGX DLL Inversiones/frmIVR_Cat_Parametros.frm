...
Begin VB.Form frmIVR_Cat_Parametros 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "SCGI Parámetros del Sistema"
   ClientHeight    =   8364
   ClientLeft      =   36
   ClientTop       =   384
   ClientWidth     =   9972
   ...
   Begin FPSpreadADO.fpSpread vGrid 
      ...
      MaxCols         =   496
      ScrollBars      =   2
      SpreadDesigner  =   "frmIVR_Cat_Parametros.frx":0000
   ...
   Begin XtremeSuiteControls.Label Label2 
      ...
      _ExtentY        =   868
      _StockProps     =   79
      Caption         =   "Parámetros Generales de SCGI"
      ForeColor       =   16777215
   ...
   End
End
Attribute VB_Name = "frmIVR_Cat_Parametros"
...
strSQL = "exec spIVR_PARAMETROS"
Call ConectionExecute(strSQL)

strSQL = "select * from IVR_PARAMETROS" _
      ...
      For i = 1 To 3
        ...
        Select Case i
          Case 1 'Codigo
            ...
            .CellNote = "Modificado Por: " & rs!ACTUALIZA_USUARIO & vbCrLf & "Fecha: " & rs!ACTUALIZA_FECHA
...
strSQL = "update IVR_PARAMETROS set ACTUALIZA_usuario = '" & glogon.Usuario & "', ACTUALIZA_Fecha = dbo.MyGetdate()" _
...
With glogon
    .strSQL = "select Valor from IVR_PARAMETROS where Cod_Parametro = '" & pParametro & "'"
