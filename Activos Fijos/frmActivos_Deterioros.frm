...
Begin VB.Form frmActivos_Deterioros 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Registro de Deterioros"
   ClientHeight    =   5790
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   10065
   ...
   Begin XtremeSuiteControls.TabControl tcMain 
      ...
      Item(0).Control(7)=   "Label6(5)"
      Item(0).Control(8)=   "Label6(6)"
      Item(0).Control(9)=   "txtMonto"
      Item(0).Control(10)=   "txtRevaluacion"
      Item(0).Control(11)=   "Label6(7)"
      Item(0).Control(12)=   "Label6(8)"
      Item(0).Control(13)=   "Label6(9)"
      Item(0).Control(14)=   "Label6(10)"
      Item(0).Control(15)=   "Label6(11)"
      Item(0).Control(16)=   "lblPeriodo"
      Item(0).Control(17)=   "lblHistorico"
      Item(0).Control(18)=   "lblRescate"
      Item(0).Control(19)=   "lblDepreciacion"
      Item(0).Control(20)=   "lblLibros"
      Item(0).Control(21)=   "lblID"
      ...
      Begin XtremeSuiteControls.Label Label6 
         ...
         _ExtentY        =   1080
         _StockProps     =   79
         Caption         =   "Indique el valor actual (Estudio) del activo:"
      ...
      Begin XtremeShortcutBar.ShortcutCaption lbl 
         ...
         _ExtentY        =   656
         _StockProps     =   14
         Caption         =   "Deterioros Registrados al Activo"
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9
            Charset         =   0
   ...
   Begin XtremeSuiteControls.PushButton btnBarra 
      ...
      Appearance      =   17
      Picture         =   "frmActivos_Deterioros.frx":0000
      ImageAlignment  =   4
   End
   Begin XtremeSuiteControls.PushButton btnBarra 
      Height          =   330
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmActivos_Deterioros.frx":0632
      ImageAlignment  =   6
   End
   Begin XtremeSuiteControls.PushButton btnBarra 
      Height          =   330
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmActivos_Deterioros.frx":0C2D
      ImageAlignment  =   6
   End
   Begin XtremeSuiteControls.PushButton btnBarra 
      Height          =   330
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmActivos_Deterioros.frx":11D1
      ImageAlignment  =   6
   End
   Begin XtremeSuiteControls.PushButton btnBarra 
      Height          =   330
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmActivos_Deterioros.frx":1902
      ImageAlignment  =   6
   End
   Begin XtremeSuiteControls.PushButton btnBarra 
      Height          =   330
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmActivos_Deterioros.frx":2002
      ImageAlignment  =   6
   End
   ...
   End
End
Attribute VB_Name = "frmActivos_Deterioros"
...
If KeyCode = vbKeyReturn Or KeyCode = vbKeyTab Then txtRevaluacion.SetFocus
End Sub
...
strSQL = "select rtrim(cod_justificacion) as 'IdX',rtrim(descripcion) as 'ItmX'" _
       & " from Activos_justificaciones where tipo = 'D'"
...
Select Case Item.Index
 Case 1
    ...
    strSQL = "select X.*,rtrim(J.cod_justificacion) + '..' + J.descripcion as Justifica" _
          ...
          & " where X.num_placa = '" & txtCodigo.Text & "' and X.tipo = 'D'"
    Call OpenRecordSet(rs, strSQL, 0)
    lsw.ListItems.Clear
    Do While Not rs.EOF
...
If Not rs.BOF And Not rs.EOF Then
  ...
  lblID.Caption = "Deterioro Id: " & rs!id_AddRet
  lblID.Visible = True
...
If Len(vMensaje) = 0 Then
 If CCur(lblLibros.Caption) <= CCur(txtRevaluacion) Then vMensaje = vMensaje & vbCrLf & " - El valor en libros no puede ser menor que la revaluacion ..."
End If
...
strSQL = "exec spActivos_AdicionRetiro '" & txtCodigo.Text & "','D','" & cbo.ItemData(cbo.ListIndex) & "','" & txtDescripcion.Text _
        & "','" & Format(dtpFecha.Value, "yyyy/mm/dd") & "'," & Abs(CCur(txtMonto.Text)) & ",1,'" & glogon.Usuario _
        & "','', '', '', '' "
Call OpenRecordSet(rs, strSQL, 0)
...
strSQL = "Deterioro (Placa:" & vCodigo & ") Id.:" & lblID.Tag & "  :" & cbo.Text
...
If i = vbYes Then
  ...
  If CCur(StatusBarX.Panels(3).Text) = 0 Then
    ...
    Call Bitacora("Elimina", "Deterioro, Placa: " & vCodigo & ", Id: " & lblID.Tag)
  End If
...
On Error GoTo vError
 txtMonto.Text = Format(CCur(txtRevaluacion) - CCur(lblLibros.Caption), "Standard")
vError:
End Sub

Private Sub txtRevaluacion_GotFocus()
On Error GoTo vError
 txtRevaluacion.Text = CCur(txtRevaluacion)
vError:
End Sub

Private Sub txtRevaluacion_LostFocus()
On Error GoTo vError
 txtRevaluacion.Text = Format(CCur(txtRevaluacion), "Standard")
vError:
End Sub
