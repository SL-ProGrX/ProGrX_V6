...
Begin VB.Form frmActivos_ObrasTipoDesem 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ...
   Begin FPSpreadADO.fpSpread vGrid 
      ...
      MaxCols         =   3
      ScrollBars      =   2
      SpreadDesigner  =   "frmActivos_ObrasTipoDesem.frx":000C
   ...
   End
End
Attribute VB_Name = "frmActivos_ObrasTipoDesem"
...
strSQL = "select coalesce(count(*),0) as Existe from Activos_obras_tdesem " _
       & " where cod_desembolso = '" & vGrid.Text & "'"
Call OpenRecordSet(rs, strSQL, 0)

If rs!Existe = 0 Then 'Insertar
  If Trim(vGrid.Text) = "" Then Exit Function
  
  strSQL = "insert into Activos_obras_tdesem(cod_desembolso,descripcion,activo,registro_usuario,registro_fecha) values('" _
         & vGrid.Text & "','"
  vGrid.Col = 2
  ...
  vGrid.Col = 1
  Call Bitacora("Registra", "Tipo de Desem. para Obra en Proceso : " & vGrid.Text)

Else 'Actualizar

 vGrid.Col = 2
 strSQL = "update Activos_obras_tdesem set descripcion = '" & vGrid.Text & "',Activo = "
 vGrid.Col = 3
 strSQL = strSQL & vGrid.Value & ",modifica_usuario = '" & glogon.Usuario & "',modifica_fecha = getdate()" _
        & " where cod_desembolso = '"
 vGrid.Col = 1
 strSQL = strSQL & vGrid.Text & "'"
 Call ConectionExecute(strSQL)

  vGrid.Col = 1
  Call Bitacora("Modifica", "Tipo de Desem. para Obra en Proceso : " & vGrid.Text)
...
If KeyCode = vbKeyDelete Then
  vGrid.Row = vGrid.ActiveRow
  vGrid.Col = 1
  strSQL = "delete Activos_obras_tdesem where cod_desembolso = '" & vGrid.Text & "'"
  Call ConectionExecute(strSQL)
  
  Call Bitacora("Elimina", "Tipo de Desem. para Obra en Proceso : " & vGrid.Text)
