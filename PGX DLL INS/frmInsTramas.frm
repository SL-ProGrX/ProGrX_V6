...
Begin VB.Form frmInsTramas 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Tramas (Formatos) Envío / Recepción de Tramas"
   ClientHeight    =   6825
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   11310
   ...
   Begin TabDlg.SSTab ssTab 
      ...
      TabPicture(0)   =   "frmInsTramas.frx":0000
      ...
      Tab(0).Control(12)=   "txtArchivo"
      Tab(0).Control(13)=   "txtCambio"
      Tab(0).Control(14)=   "txtNoExiste"
      Tab(0).Control(15)=   "txtExiste"
      Tab(0).Control(16)=   "txtCasos"
      Tab(0).Control(17)=   "txtMonto"
      Tab(0).Control(18)=   "dtpCuota"
      Tab(0).ControlCount=   19
      TabCaption(1)   =   "Envío al INS"
      TabPicture(1)   =   "frmInsTramas.frx":00FE
      ...
      Tab(1).Control(4)=   "tlbTrama"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "cboRemesa"
      ...
      Begin FPSpreadADO.fpSpread vGrid 
         ...
         EndProperty
         MaxCols         =   495
         SpreadDesigner  =   "frmInsTramas.frx":01FB
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInsTramas.frx":086A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInsTramas.frx":70CC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInsTramas.frx":D92E
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmInsTramas.frx":14190
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmInsTramas"
...
strSQL = "update Pol set Pol.COD_ALTERNO = '001' + Seg.TIPO_SEGURO_EXT + '0000' + right(Pol.Num_Poliza,9)" _
       & " FROM INS_POLIZAS Pol inner join Ins_Tipos_Seguros Seg on Pol.Tipo_Seguro = Seg.Tipo_Seguro" _
       & " Where Pol.COD_ALTERNO Is Null"
   ...
   If Len(strCadena) >= 66 Then 'Largo de la Trama
            With vGrid
               ...
               .Text = Mid(strCadena, 5, 20)
                ...
                strSQL = "select * from Ins_Polizas where (num_poliza = '" & .Text & "' or COD_ALTERNO ='" & .Text & "')"
...
With vGrid
    For lng = 1 To .MaxRows
       ...
       If .Value = vbChecked Then 'El Caso Existe
            ...
            'Revisar si existe la cuota y cambia los datos
            strSQL = "select isnull(max(Linea) ,0) + 1 as 'Linea' from ins_pagos where num_poliza = '" & pPolizaNum & "' and num_cuota = " & pCtaNum
            rs.Open strSQL, glogon.Conection, adOpenStatic
                vLinea = rs!Linea
            rs.Close
            
            'Registra Cuota al Cobro
            strSQL = "insert ins_pagos(Linea,num_poliza,num_cuota,monto,monto_neto,monto_pago,fecha_vence,fecha_cuota,registro_fecha,registro_usuario)" _
                   & " values(" & vLinea & ",'" & pPolizaNum & "'," & pCtaNum & "," & pMonto & "," & pMonto & ",0,'" & Format(dtpVence.Value, "yyyy/mm/dd") _
                   & "','" & Format(dtpCuota.Value, "yyyy/mm/dd") & "',dbo.MyGetdate(),'" & glogon.Usuario & "')"
            glogon.Conection.Execute strSQL
...
strSQL = "select Pol.TIPO_SEGURO,4 as 'Tipo_Mov', Pol.NUM_POLIZA,Pag.FECHA_VENCE,Pol.TIPO_CUENTA,Pol.Cod_Alterno" _
...
Do While Not rs.EOF
 ...
 vCadena = vCadena & SIFGlobal.fxSIFRelleno(rs!Cod_Alterno, "D", " ", 20)
