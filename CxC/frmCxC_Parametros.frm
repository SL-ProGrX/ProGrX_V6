...
Begin VB.Form frmCxC_Parametros 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Parámetros de CxC"
   ClientHeight    =   6024
   ClientLeft      =   48
   ClientTop       =   372
   ClientWidth     =   8700
   ...
   Begin FPSpreadADO.fpSpread vGrid 
      ...
      MaxCols         =   496
      ScrollBars      =   2
      SpreadDesigner  =   "frmCxC_Parametros.frx":0000
      VScrollSpecialType=   2
      AppearanceStyle =   1
   End
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Parámetros de Cuentas por Cobrar"
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   13.8
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmCxC_Parametros"
...
strSQL = "exec spCxC_Parametros"
Call ConectionExecute(strSQL)


strSQL = "select * from CxC_Parametros" _
...
strSQL = "update CxC_Parametros set modifica_usuario = '" & glogon.Usuario & "', modifica_Fecha = dbo.MyGetdate()" _
       & ",valor = '" & Trim(pValor) & "' where cod_parametro = '" & pParametro & "'"
Call ConectionExecute(strSQL)

strSQL = "Parámetro de CxC: " & pParametro & " -> " & pValor
