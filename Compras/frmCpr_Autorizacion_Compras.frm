...
Begin VB.Form frmCpr_Autorizacion_Compras 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   Caption         =   "Autorizaciones de Compras"
   ClientHeight    =   7320
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   12060
   ...
   Begin XtremeSuiteControls.PushButton cmdBuscar 
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmCpr_Autorizacion_Compras.frx":0000
      ImageAlignment  =   0
   End
   Begin XtremeSuiteControls.PushButton cmdRechazar 
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmCpr_Autorizacion_Compras.frx":0700
   End
   Begin XtremeSuiteControls.PushButton cmdAutorizar 
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmCpr_Autorizacion_Compras.frx":0CA4
   End
   ...
   Begin XtremeSuiteControls.PushButton btnExportar 
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmCpr_Autorizacion_Compras.frx":13CB
      ImageAlignment  =   0
   End
   ...
   End
End
Attribute VB_Name = "frmCpr_Autorizacion_Compras"
...
'       & cboUEN.ItemData(cboUEN.ListIndex) & "' and O.genera_user in(" _
...
'Call sbCprCboTiposOrden(cboUEN)

With lsw.ColumnHeaders
    .Clear
    .Add , , "No Solicitud", 1600
    .Add , , "UEN", 2500
    .Add , , "Estado", 2500, vbCenter
    .Add , , "Fecha", 2500, vbCenter
    .Add , , "Usuario", 2500, vbCenter
    .Add , , "Monto", 1800, vbRightJustify
    .Add , , "Presupuesto?", 1500
    .Add , , "Detalle", 2500
End With
