...
If rs!Existe = 0 Then 'Insertar
  ...
  vGrid.col = 1
  Call Bitacora("Registra", "Catálogo de Tipos de Rechazos de Compras Id: " & vGrid.Text)
...
Else 'Actualizar
 ...
 vGrid.col = 1
 Call Bitacora("Modifica", "Catálogo de Tipos de Rechazos de Compras Id: " & vGrid.Text)
...
If KeyCode = vbKeyDelete Then
   ...
   vGrid.col = 1
     ...
     If i = vbYes Then
        ...
        strSQL = vGrid.Text
        vGrid.col = 1
        Call Bitacora("Elimina", "Catálogo de Tipos de Rechazos de Compras Id: " & vGrid.Text)
