...
Begin VB.Form frmAF_RemesasLiquidaciones 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Remesas Liquidaciones "
   ClientHeight    =   7665
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10425
   HelpContextID   =   3030
   Icon            =   "frmAF_RemesasLiquidaciones.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7665
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":000C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":169CE
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":2D390
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":42502
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":57674
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList imgToolbarIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   9
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":6E036
            Key             =   "New"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":6E148
            Key             =   "Properties"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":6E25A
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":6E36C
            Key             =   "Save"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":6E47E
            Key             =   "Undo"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":6E590
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":6E6A2
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":6E7B4
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":6E8C6
            Key             =   "Open"
         EndProperty
      EndProperty
   End
   Begin TabDlg.SSTab ssTab 
      ...
      EndProperty
      TabCaption(0)   =   "Remesa"
      TabPicture(0)   =   "frmAF_RemesasLiquidaciones.frx":6E9D8
      ...
      TabCaption(1)   =   "Cargar"
      TabPicture(1)   =   "frmAF_RemesasLiquidaciones.frx":6E9F4
      ...
      TabPicture(2)   =   "frmAF_RemesasLiquidaciones.frx":6EA10
      ...
      TabPicture(3)   =   "frmAF_RemesasLiquidaciones.frx":6EA2C
      ...
      Begin XtremeSuiteControls.PushButton cmdReporte 
         ...
         Appearance      =   17
         Picture         =   "frmAF_RemesasLiquidaciones.frx":6EA48
      End
      Begin VB.Line Line9 
   ...
   Begin MSComctlLib.ImageList ImageListX 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":6F204
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":75A66
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":7C2C8
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RemesasLiquidaciones.frx":82B2A
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmAF_RemesasLiquidaciones"
...
strSQL = "select fecha_inicio,fecha_corte from AFI_REMESAS_LIQ where cod_remesa = " & cboCarga.ItemData(cboCarga.ListIndex)
...
strSQL = "select rtrim(cod_oficina) + ' - ' + rtrim(descripcion) as Itmx" _
       ...
       & " from Liquidacion  where Fecliq between '" & Format(vFechaInicio, "yyyy/mm/dd") & " 00:00:00'" _
...
strSQL = "select * from AFI_REMESAS_LIQ where Cod_Remesa = " & pRemesa
Call OpenRecordSet(rs, strSQL)
...
If chkRemesaInd.Value = vbChecked Then
   xRemesa = InputBox("Indique la Remesa que desea consultar", "Remesas de Traslado a Microfilmado")
...
End If
 ...
 Select Case True
  Case opt.Item(0).Value 'Pendiente Detalle Remesa
     .ReportFileName = SIFGlobal.fxPathReportes("Personas_RemesasLiqDetalle.rpt")
     vSubTitulo = "REMESA : " & lblRemesa.Tag & " LISTADO : DETALLADO"
  Case opt.Item(1).Value 'Traslado Detalle Agrupado Remesa
     .ReportFileName = SIFGlobal.fxPathReportes("Personas_RemesasLiqDetalleAgrp.rpt")
 ...
 .Formulas(3) = "fxTitulo='REMESA TRASLADO MICROFILM : LIQUIDACIONES OBRERO/PATRONALES'"
 .Formulas(4) = "fxSubTitulo='" & vSubTitulo & "'"
 .SelectionFormula = "{AFI_REMESAS_LIQ.COD_REMESA} = " & lblRemesa.Tag
...
Select Case UCase(Button.Key)
  Case "NUEVO"
    ...
    If txtRemesa.Text = "" Then
            ...
            strSQL = "select isnull(max(cod_remesa),0) + 1 as Ultimo from AFI_REMESAS_LIQ"
            Call OpenRecordSet(rs, strSQL)
                strSQL = "insert AFI_REMESAS_LIQ(cod_remesa,usuario,fecha,estado,fecha_inicio,fecha_corte,notas) values(" & rs!ultimo _
    ...
    Else
        If txtEstado.Text <> "Remesa Cerrada" Then
            ...
            strSQL = "update AFI_REMESAS_LIQ set usuario = '" & glogon.Usuario & "',fecha_inicio = '" & Format(dtpInicio.Value, "yyyy/mm/dd") _
  ...
  Case "BORRAR"
     ...
     If i = vbYes Then
        ...
        If txtEstado.Text = "Remesa Abierta" Then
            ...
            strSQL = "delete AFI_REMESAS_LIQ where Cod_Remesa = " & txtRemesa
            Call ConectionExecute(strSQL)
...
Select Case ssTab.Tab
  Case 0 'Remesas
    ...
    txtNotas.Text = ""
     ...
     strSQL = "select TOP 150 * from AFI_REMESAS_LIQ order by fecha desc"
  ...
  Case 1 'Carga
    ...
    strSQL = "select * from AFI_REMESAS_LIQ where estado = 'A' order by fecha desc"
    Call OpenRecordSet(rs, strSQL)
    Do While Not rs.EOF
  ...
  Case 2 'Reportes
     strSQL = "select TOP " & txtRepRemesas.Text & " * from AFI_REMESAS_LIQ order by fecha desc"
...
strSQL = "select L.Consec,L.Cedula,S.nombre,L.FecLiq" _
       & " from  Liquidacion L inner join Socios S on L.cedula = S.cedula" _
       & " where L.FecLiq between '" & Format(vFechaInicio, "yyyy/mm/dd") & " 00:00:00'" _
       & " and '" & Format(vFechaCorte, "yyyy/mm/dd") & " 23:59:59' and L.cod_remesa is null" _
       & " and dbo.fxSIFTagCierre(l.CEDULA, L.CONSEC,'LIQ') = 1"
       
If cboOficina.Text <> "TODOS" Then
   strSQL = strSQL & " and L.cod_Oficina = '" & SIFGlobal.fxCodText(cboOficina.Text) & "'"
End If
...
With lswCarga
 ...
 Do While Not rs.EOF
   ...
   Set itmX = .ListItems.Add(, , rs!consec)
       ...
       itmX.SubItems(3) = Format(rs!fecLiq, "dd/mm/yyyy")
...
strSQL = "select count(*) as Existe from AFI_REMESAS_LIQ" _
...
strSQL = "update AFI_REMESAS_LIQ set estado = 'C'" _
       & " where cod_remesa = " & cboCarga.ItemData(cboCarga.ListIndex)
Call ConectionExecute(strSQL)

 
Call Bitacora("Aplica", "Cierra Remesa Liquidaciones a Microfilmado : " & cboCarga.ItemData(cboCarga.ListIndex))
...
For i = 1 To .Count
 If .Item(i).Checked Then
      ...
      strSQL = "update Liquidacion set cod_remesa = " & cboCarga.ItemData(cboCarga.ListIndex) & " where consec = " & .Item(i).Text & ""
      Call ConectionExecute(strSQL)
...
If vCasos > 0 Then
    Call Bitacora("Aplica", "Carga Remesa Liquidaciones a Microfilmado : " & cboCarga.ItemData(cboCarga.ListIndex))
End If
...
Select Case Button.Key
  Case "aplicar"
     ...
     If cmdMicrofilm.Enabled Then
         strSQL = "update AFI_REMESAS_LIQ set Microfilm_Fecha = dbo.MyGetdate(), Microfilm_usuario = '" & glogon.Usuario _
...
Private Sub txtLiq_KeyDown(KeyCode As Integer, Shift As Integer)
...
strSQL = "select A.* from AFI_REMESAS_LIQ A inner join Liquidacion X on A.cod_remesa = X.cod_remesa where X.consec = '" & txtLiq & "'"
Call OpenRecordSet(rs, strSQL)

If rs.BOF Or rs.EOF Then txtConRemesa.Text = "** No se encontró Liquidación en las remesas registradas **"
Do While Not rs.EOF
...
strSQL = "select * from AFI_REMESAS_LIQ where cod_remesa = " & txtReciboRemesa.Text
Call OpenRecordSet(rs, strSQL)
