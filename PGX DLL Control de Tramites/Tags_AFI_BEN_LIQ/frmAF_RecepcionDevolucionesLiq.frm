...
Begin VB.Form frmAF_RecepcionDevolucionesLiq 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Liquidaciones..: Recepción Devoluciones"
   ClientHeight    =   8160
   ClientLeft      =   48
   ClientTop       =   372
   ClientWidth     =   12072
   ...
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Picture         =   "frmAF_RecepcionDevolucionesLiq.frx":0000
   ScaleHeight     =   8160
   ScaleWidth      =   12072
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RecepcionDevolucionesLiq.frx":6852
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RecepcionDevolucionesLiq.frx":D0B4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAF_RecepcionDevolucionesLiq.frx":13916
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Label Label1 
      Caption         =   "Liquidaciones ..: Recepción de Devoluciones"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   15.6
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmAF_RecepcionDevolucionesLiq"
...
On Error GoTo vError
    ...
    If fxValidaNoDuplicados = True Then
        MsgBox "La Boleta ya fue digitada!", vbExclamation
...
'    strSQL = "SELECT dbo.fxSIFValidaTagRev('" & Trim(txtCodigo) & "','" & Trim(mTagDevolucion) & "','" & Trim(mTagDevolucion) & "','06')"
'    Call OpenRecordSet(rs, strSQL)
'    If Not rs.EOF Then
...
'    rs.Close
    ...
    strSQL = "SELECT L.CEDULA,S.nombre,L.CONSEC ,isnull(O.DESCRIPCION,'') as DESCRIPCION " _
           ...
           & " WHERE L.CEDULA in (select codigo from SIF_CONTROL_TAGS where Documento = '" & Trim(txtCodigo.Text) _
           & "' and TAG_CODIGO = 'S04' and cod_modulo = 'LIQ') " _
...
For i = 1 To .Count
        Call sbSIFRegistraTags(.Item(i).Text, mTagDevolucion, "Recepción de Devolución la documentación de la Liquidación" _
                             , .Item(i).SubItems(3), "LIQ", .Item(i).Text, .Item(i).SubItems(3))
...
Dim i As Integer
    ...
    For i = 1 To lsw.ListItems.Count
        ...
        If Trim(lsw.ListItems(i).Text) = Trim(txtCodigo.Text) Then
