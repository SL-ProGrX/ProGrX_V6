...
Begin VB.Form frmAF_LiquidacionRevision 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(0)=   "lblBoleta"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "Label1"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "lblTipoLiq"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).Control(3)=   "Label4"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "Label3"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "lblAhorro"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "lblAporte"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "Label7"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "lblCapitaliza"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "Label10"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "Label11"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "lblTotalLiq"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "Label13(0)"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "lblGirado"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "Label15"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "lblRetenido"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "Label17"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "lblRige"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "Label19"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).Control(19)=   "lblAccion"
      Tab(1).Control(19).Enabled=   0   'False
      Tab(1).Control(20)=   "lblFechaLiq"
      Tab(1).Control(20).Enabled=   0   'False
      Tab(1).Control(21)=   "Label22"
      Tab(1).Control(21).Enabled=   0   'False
      Tab(1).Control(22)=   "Label23"
      Tab(1).Control(22).Enabled=   0   'False
      Tab(1).Control(23)=   "Line1"
      Tab(1).Control(23).Enabled=   0   'False
      Tab(1).Control(24)=   "lblEmitir"
      Tab(1).Control(24).Enabled=   0   'False
      Tab(1).Control(25)=   "Label21"
      Tab(1).Control(25).Enabled=   0   'False
      Tab(1).Control(26)=   "lblBanco"
      Tab(1).Control(26).Enabled=   0   'False
      Tab(1).Control(27)=   "Label25"
      Tab(1).Control(27).Enabled=   0   'False
      Tab(1).Control(28)=   "lblCausa"
      Tab(1).Control(28).Enabled=   0   'False
      Tab(1).Control(29)=   "Label28"
      Tab(1).Control(29).Enabled=   0   'False
      Tab(1).Control(30)=   "Label13(1)"
      Tab(1).Control(30).Enabled=   0   'False
      Tab(1).Control(31)=   "lblCuenta"
      Tab(1).Control(31).Enabled=   0   'False
      Tab(1).Control(32)=   "lswDetalle"
      ...
      Tab(3).Control(2)=   "Label8(1)"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "lswErrores"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "tlbAplicar"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "cboEtiquetas"
      Tab(3).Control(5).Enabled=   0   'False
      Tab(3).Control(6)=   "txtObservacion"
