...
Begin VB.Form frmFND_RecepcionLiqFondosTags 
   ...
   Begin TabDlg.SSTab SSTab 
      ...
      TabPicture(0)   =   "frmFND_RecepcionLiqFondosTags.frx":0000
      ...
      Tab(0).Control(3)=   "PrgBar"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "tlbAplicar"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "lswLiq"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "optDevolucion"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "optRecepcion"
      ...
      TabPicture(1)   =   "frmFND_RecepcionLiqFondosTags.frx":001C
      ...
      Begin FPSpreadADO.fpSpread vGrid 
         ...
         SpreadDesigner  =   "frmFND_RecepcionLiqFondosTags.frx":0054
      ...
      Begin FPSpreadADO.fpSpread vGridConsulta 
         ...
         MaxCols         =   486
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "frmFND_RecepcionLiqFondosTags.frx":0770
         VScrollSpecialType=   2
         AppearanceStyle =   1
      End
      ...
      Begin VB.Image Image3 
         Height          =   480
         Left            =   -74760
         Picture         =   "frmFND_RecepcionLiqFondosTags.frx":0CED
         Top             =   1440
         Width           =   480
      End
      ...
      Begin VB.Image Image4 
         Height          =   480
         Left            =   -74760
         Picture         =   "frmFND_RecepcionLiqFondosTags.frx":0F06
         Top             =   480
         Width           =   480
      End
      ...
      Begin VB.Image Image2 
         Height          =   480
         Left            =   -74760
         Picture         =   "frmFND_RecepcionLiqFondosTags.frx":1110
         Top             =   480
         Width           =   480
      End
      Begin VB.Image Image1 
         Height          =   480
         Left            =   240
         Picture         =   "frmFND_RecepcionLiqFondosTags.frx":1321
         Top             =   600
         Width           =   480
      End
      Begin VB.Label LblCedula 
         AutoSize        =   -1  'True
         Caption         =   "Código Boleta"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFND_RecepcionLiqFondosTags.frx":1513
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFND_RecepcionLiqFondosTags.frx":7D75
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFND_RecepcionLiqFondosTags.frx":E5D7
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImageList3 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   6
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFND_RecepcionLiqFondosTags.frx":14E39
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFND_RecepcionLiqFondosTags.frx":1B69B
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFND_RecepcionLiqFondosTags.frx":21EFD
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFND_RecepcionLiqFondosTags.frx":22017
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFND_RecepcionLiqFondosTags.frx":22135
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFND_RecepcionLiqFondosTags.frx":28997
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmFND_RecepcionLiqFondosTags"
...
On Error GoTo vError
    ...
    If optRecepcion.Value Then
        ...
        Call OpenRecordSet(rs, strSQL)
         If rs.Fields(0) = 2 Then
            MsgBox "No es posible registrar en forma consecutiva dos recepciones en la cedula " & txtCodigo.Text
            txtCodigo.Text = Empty
            rs.Close
            Exit Sub
        End If
    Else
        ...
        Call OpenRecordSet(rs, strSQL)
         If rs.Fields(0) = 3 Then
            MsgBox "No es posible registrar en forma consecutiva dos devoluciones en la cedula " & txtCodigo.Text
            txtCodigo.Text = Empty
            rs.Close
            Exit Sub
   ...
   rs.Close
    ...
    If rs.Fields(0) = 4 Then
       MsgBox "No es posible registrar una recepción sin aplicar la devolución en la cedula " & txtCodigo.Text
       txtCodigo.Text = Empty
       rs.Close
        Exit Sub
    End If
...
For i = 1 To .Count
    ...
    If optRecepcion.Value = True Then
        ...
        Call sbSIFRegistraTags(.Item(i).SubItems(3), mTagRecepcion, "Recibida la documentación de la Liquidación", "NULL", "FLQ")
        strSQL = "update fnd_liquidacion set analista_recepcion  = 1 where consec = " & .Item(i).SubItems(3) & " "
        Call ConectionExecute(strSQL)
        
    Else
        Call sbSIFRegistraTags(.Item(i).SubItems(3), mTagDevolucion, "Devolución la documentación de la Liquidación", "NULL", "FLQ")
    End If
...
On Error GoTo error
    ...
    If optPendRecepcion.Value = True Then
        strSQL = "SELECT F.CEDULA,S.nombre,L.CONSEC ,isnull(O.DESCRIPCION,'') as DESCRIPCION,L.Fecha,L.USUARIO" _
               & " FROM fnd_liquidacion L  inner join FND_CONTRATOS F" _
               & " on L.COD_PLAN = F.COD_PLAN and L.COD_CONTRATO = F.COD_CONTRATO" _
               & " AND L.COD_OPERADORA = F.COD_OPERADORA" _
               & " inner join SOCIOS S on F.CEDULA = S.CEDULA" _
               & " LEFT JOIN SIF_OFICINAS O ON L.COD_OFICINA = O.COD_OFICINA" _
               & " Where L.ANALISTA_RECEPCION = 0"
...
On Error GoTo vError
   ...
   strSQL = "select T.DESCRIPCION, CT.NOTAS, CT.REGISTRO_FECHA, CT.REGISTRO_USUARIO from SIF_CONTROL_TAGS CT" _
           & " inner join SIF_TAGS T on CT.TAG_CODIGO = T.TAG_CODIGO where CT.codigo = '" & txtCodigoBuscar _
