   ...
   Begin MSComctlLib.ImageList imgExplorer 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":0038
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":0914
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":11F0
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":150C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":1828
            Key             =   "imgRoot"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":1B44
            Key             =   "imgFolder"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":1E60
            Key             =   "imgOpcion"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":217C
            Key             =   "imgUsuario"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":2A58
            Key             =   "imgGrupo"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":3334
            Key             =   "imgAsientos"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaCuentas.frx":3650
            Key             =   "imgCuentas"
         EndProperty
      EndProperty
   End
...
If vNode.Bold = False Then
    If vNode.Text <> "Cuentas" And Right(vNode.Key, 1) <> "T" Then
        ...
        Unload frmCntX_ConsultaCuentas
    End If
Else
...
With ArbolExp
  ...
  strSQL = "select tipo_cuenta,Descripcion from CntX_tipos_cuentas where cod_contabilidad = " & GLOBALES.gEnlace
  rs.Open strSQL, glogon.Conection, adOpenStatic
  Do While Not rs.EOF
...
Select Case Right(Node.Key, 1)
    ...
    Case Else 'SubCuentas
        ...
        strSQL = "select cod_cuenta,descripcion,acepta_movimientos from CntX_cuentas where cuenta_madre = '" & fxgCntCuentaFormato(False, fxIndiceCodigo(Node.Key)) _
...
Set nodX = ArbolExp.Nodes.Add(vPadre, tvwChild)
    ...
    If vAcepta = "N" Or vAcepta = "0" Then nodX.Bold = True
