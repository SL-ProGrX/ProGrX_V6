...
Begin VB.Form frmCO_AplFnd_Procesa 
   ...
   Caption         =   "Aplicación de Fondos a Mora"
   ClientHeight    =   7995
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   12885
   ...
   Begin XtremeSuiteControls.GroupBox gbDetalle 
      ...
      Begin XtremeSuiteControls.FlatEdit txtTAcuerdos 
         ...
         UseVisualStyle  =   0   'False
      End
      Begin XtremeSuiteControls.FlatEdit txtTFondos 
         Height          =   315
         Left            =   5760
         TabIndex        =   4
         Top             =   720
         ...
         UseVisualStyle  =   0   'False
      End
      Begin XtremeSuiteControls.FlatEdit txtTObrero 
         Height          =   315
         Left            =   5760
         TabIndex        =   5
         Top             =   1080
         ...
         UseVisualStyle  =   0   'False
      End
      Begin XtremeSuiteControls.FlatEdit txtTSINPE 
         Height          =   315
         Left            =   5760
         TabIndex        =   6
         Top             =   360
      ...
      Begin XtremeSuiteControls.Label Label2 
         ...
         _ExtentY        =   450
         _StockProps     =   79
         Caption         =   "Total disponible SINPE"
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9
            Charset         =   0
      ...
      Begin XtremeSuiteControls.Label Label2 
         ...
         _ExtentY        =   450
         _StockProps     =   79
         Caption         =   "Total disponible Fondos"
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9
            Charset         =   0
   ...
   Begin XtremeSuiteControls.PushButton btnExportar 
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmCO_AplFnd_Procesa.frx":0000
   End
   Begin XtremeSuiteControls.PushButton btnCargar 
      ...
      UseVisualStyle  =   -1  'True
      Appearance      =   17
      Picture         =   "frmCO_AplFnd_Procesa.frx":016A
   End
   Begin XtremeSuiteControls.GroupBox gbAplicacion 
      ...
      Begin XtremeSuiteControls.PushButton btnAplicar 
         ...
         UseVisualStyle  =   -1  'True
         Appearance      =   17
         Picture         =   "frmCO_AplFnd_Procesa.frx":0883
      End
   ...
   End
End
Attribute VB_Name = "frmCO_AplFnd_Procesa"
...
With lsw.ColumnHeaders
    ...
    .Add , , "Ahorros", 1800, vbRightJustify
