...
Begin VB.Form frmCO_CJ_Bufetes 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cobros: Bufetes (Firmas) de Abogados"
   ClientHeight    =   6780
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   11190
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCO_CJ_Bufetes.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCO_CJ_Bufetes.frx":3492
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCO_CJ_Bufetes.frx":6924
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCO_CJ_Bufetes.frx":6A42
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmCO_CJ_Bufetes"
...
If vScroll Then
    strSQL = "select Top 1 cod_bufete from Cbr_Cj_Bufetes"
    
    If FlatScrollBar.Value = 1 Then
       strSQL = strSQL & " where cod_bufete > '" & txtCodigo.Text & "' order by cod_bufete asc"
    Else
       strSQL = strSQL & " where cod_bufete < '" & txtCodigo.Text & "' order by cod_bufete desc"
    End If
    
    Call OpenRecordSet(rs, strSQL)
    If Not rs.EOF And Not rs.BOF Then
      txtCodigo.Text = rs!cod_bufete
...
If Not rs.BOF And Not rs.EOF Then
  ...
  vCodigo = rs!cod_bufete
  txtCodigo = rs!cod_bufete
...
If vEdita Then
  strSQL = "update Cbr_Cj_Bufetes set nombre = '" & Trim(txtNombre.Text) & "',Telefono_01 = '" & txtTelefono.Text & "',Telefono_02 = '" & txtTelefono2.Text _
         ...
         & "',Nombre_Contacto = '" & txtContacto.Text & "', Tel_Cel = '" & txtCelular.Text & "',Activo = " & chkActivo.Value _
         & " where cod_bufete = '" & vCodigo & "'"
  Call ConectionExecute(strSQL)
  
  Call Bitacora("Modifica", "Cobros Buffete: " & vCodigo)

Else
  vCodigo = txtCodigo

   strSQL = "insert into Cbr_Cj_Bufetes(cod_bufete,nombre,Telefono_01,Telefono_02, Tel_fax, Tel_Cel, Activo,registro_fecha,registro_usuario" _
          & ",apto_postal,email_01,email_02,Sitio_Web,direccion,distrito,provincia,canton,nombre_contacto)" _
          & " values('" & vCodigo & "','" & txtNombre.Text & "','" & txtTelefono.Text & "','" & txtTelefono2.Text & "','" & txtTelFax.Text & "','" & txtCelular.Text _
   ...
   Call Bitacora("Registra", "Cobros Buffete: " & vCodigo)
...
If i = vbYes Then
  strSQL = "delete Cbr_Cj_Bufetes where cod_bufete = '" & vCodigo & "'"
  Call ConectionExecute(strSQL)

  Call Bitacora("Elimina", "Cobros Buffete: " & vCodigo)
  Call sbLimpiaPantalla
  Call sbToolBar(tlb, "nuevo")
  Call RefrescaTags(Me)
...
If KeyCode = vbKeyF4 Then
  ...
  gBusquedas.Columna = "cod_bufete"
  gBusquedas.Orden = "cod_bufete"
  gBusquedas.Consulta = "select cod_bufete,nombre from Cbr_Cj_Bufetes"
  gBusquedas.Filtro = ""
  frmBusquedas.Show vbModal
  txtCodigo = gBusquedas.Resultado
