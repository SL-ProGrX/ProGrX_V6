...
Begin VB.Form frmAH_RegistraAhorroH 
   ...
   ClientWidth     =   5685
   HelpContextID   =   2006
   Icon            =   "frmAH_RegistraAhorroH.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2505
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboMes 
         Height          =   315
         ItemData        =   "frmAH_RegistraAhorroH.frx":030A
         Left            =   1200
         List            =   "frmAH_RegistraAhorroH.frx":0335
   ...
   Begin VB.CommandButton cmdCancelar 
      ...
      Height          =   855
      Left            =   4560
      Picture         =   "frmAH_RegistraAhorroH.frx":039E
      Style           =   1  'Graphical
      TabIndex        =   5
   ...
   Begin VB.CommandButton cmdGenerarRecibo 
      ...
      Height          =   855
      Left            =   3480
      Picture         =   "frmAH_RegistraAhorroH.frx":06A8
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmAH_RegistraAhorroH"
