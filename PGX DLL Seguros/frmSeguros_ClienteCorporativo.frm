...
Begin VB.Form frmSeguros_ClienteCorporativo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Seguros: Clientes Corporativos"
   ClientHeight    =   6720
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   11160
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSeguros_ClienteCorporativo.frx":0000
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmSeguros_ClienteCorporativo"
...
If vScroll Then
    strSQL = "select Top 1 COD_CLIENTE_CORPORATIVO from SEGUROS_CLIENTE_CORPORATIVO"
    
    If FlatScrollBar.Value = 1 Then
       strSQL = strSQL & " where COD_CLIENTE_CORPORATIVO > '" & txtCodigo.Text & "' order by COD_CLIENTE_CORPORATIVO asc"
    Else
       strSQL = strSQL & " where COD_CLIENTE_CORPORATIVO < '" & txtCodigo.Text & "' order by COD_CLIENTE_CORPORATIVO desc"
    End If
    
    Call OpenRecordSet(rs, strSQL)
    If Not rs.EOF And Not rs.BOF Then
      txtCodigo.Text = rs!Cod_Cliente_Corporativo
...
'cboFormaPago.Clear
'cboFormaPago.AddItem "TE - Transferencia"
'cboFormaPago.AddItem "CK - Cheque"
'cboFormaPago.Text = "TE - Transferencia"
'
'
'cboFormato.Clear
...
strSQL = "select P.*,rtrim(Prov.Descripcion) as ProvDesc, rtrim(Cant.Descripcion) as CantonDesc, rtrim(Dist.Descripcion) as DistDesc" _
       & " from SEGUROS_CLIENTE_CORPORATIVO P " _
       ...
       & " where P.COD_CLIENTE_CORPORATIVO = '" & xCodigo & "'"
Call OpenRecordSet(rs, strSQL)
...
If Not rs.BOF And Not rs.EOF Then
  ...
  vCodigo = rs!Cod_Cliente_Corporativo
  txtCodigo = rs!Cod_Cliente_Corporativo
...
'
'  Call sbCboAsignaDato(cboFormaPago, rs!Tipo_Pago & "")
...
'If Trim(txtBancoDesc.Text) = "" Then vMensaje = vMensaje & vbCrLf & " - Banco no es válido!..."
'If Len(txtCuentaCliente) < 9 Then vMensaje = vMensaje & vbCrLf & " - Cuenta Cliente no es válida! ..."
'
...
If vEdita Then
  strSQL = "update SEGUROS_CLIENTE_CORPORATIVO set nombre = '" & Trim(txtNombre.Text) & "', Cedula_Juridica = '" & txtCedJuridica.Text _
         ...
         & " where COD_CLIENTE_CORPORATIVO = '" & vCodigo & "'"
  Call ConectionExecute(strSQL)
  
  Call Bitacora("Modifica", "Cliente Corporativo: " & vCodigo)

Else
  vCodigo = txtCodigo

   strSQL = "insert into SEGUROS_CLIENTE_CORPORATIVO(COD_CLIENTE_CORPORATIVO,nombre,cedula_Juridica,Telefono_01,Telefono_02,Tel_fax,Activo,registro_fecha,registro_usuario" _
   ...
   Call Bitacora("Registra", "Cliente Corporativo: " & vCodigo)
...
If i = vbYes Then
  strSQL = "delete SEGUROS_CLIENTE_CORPORATIVO where COD_CLIENTE_CORPORATIVO = '" & vCodigo & "'"
  Call ConectionExecute(strSQL)

  Call Bitacora("Elimina", "Cliente Corporativo: " & vCodigo)
  Call sbLimpiaPantalla
  Call sbToolBar(tlb, "nuevo")
  Call RefrescaTags(Me)
